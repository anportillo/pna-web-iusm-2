		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6 text-light">
					<i class="fa fa-envelope-o"></i><span class="small text-light"> informes.iusm@gmail.com</span></div>
...
<!-- nav-->
	<nav class="navbar navbar-light shadow navbar-expand-lg" style="background-color: rgba(255,255,255,1); padding: 0px;">
		<div class="container" style="padding:0px;">
			...
			<a class="navbar-brand" href="index.html" style="padding:0px; width: 20%; height: 20%; margin-top: 10px"><img class="logomenu" src="img/fragmentos/logo iusm 2.png"></a>
  ...
  <div class="row">
    ...
    <div class="col-md-3" align="center">
	 ...
	 <div class="col-md-6">
      ...
      <p class="small text-light">Direcci&oacute;n de Educaci&oacute;n<br>Corrientes 180 <br>Olivos, Buenos Aires, Argentina </p>
      
      <p class="text-light small"><i class="icono-arg-telefono-neg"></i> +54 11 4512 1014</p>
		<p class="text-light small"><i class="fa fa-envelope"></i> informes.iusm@gmail.com </p>
