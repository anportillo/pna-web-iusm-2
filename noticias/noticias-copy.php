<?php
	...
	$sqlQuery0="SELECT NOTICIAID, TITULO, RESUMEN, FECHA FROM noticias WHERE ESTADOID = 1 ORDER BY FECHA DESC;";
	$result0 = sql_do_query($sqlQuery0,'1');
...
<div class="container">		
	...
	<nav class="navbar navbar-light shadow navbar-expand-lg " style="background-color: rgba(255,255,255,1); padding: 0px;">
		<div class=" container" style="padding:0px;">
			<a class="navbar-brand" href="index.html" style="padding:0px; width: 20%; height: 20%; margin-top: 10px"><img class="logomenu img-responsive" src="img/fragmentos/logo iusm.png"></a>
...
<!-- boody-->
	...
	<div class="imagen1">	
		<div class="contenedor_slider">
			<div class="fling-minislide" style="height: 300px;">
				<img src="img/fragmentos/noticias-01.jpg"  style="width: 100%">
				<img src="img/fragmentos/noticias-02.jpg"  style="width: 100%">
				<img src="img/fragmentos/noticias-03.jpg"  style="width: 100%">
				<img src="img/fragmentos/noticias-04.jpg"  style="width: 100%">
				<img src="img/fragmentos/noticias-05.jpg"  style="width: 100%">
			</div>
		</div>		
	</div>
...
<div class="imagen2">
	...
	<div class="fling-minislide">
		  <div><img src="img/fragmentos/1inicio.jpg"  style="width: 100%">  </div>
  	</div>
</div>		
</div>
...
<!--	<h3 style="color: #0072bb; font-size: 45px;">Noticias</h3>-->
	<div class="row">
	<?php while($row=sql_do_array($result0)){ ?>
		<div class="col-md-4">
			<a class="panel panel-default" href="noticiasola.php?noticiaid=<?php echo $row['NOTICIAID']; ?>">			
				<div class="panel-heading" style="background-image: url(img/fragmentos/INICIO.jpg); height: 200px;"></div>
